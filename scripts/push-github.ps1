# Push local NFA project to https://github.com/Manjith-NG/NFA-2.0-Ver
...
$remoteUrl = "https://github.com/Manjith-NG/NFA-2.0-Ver.git"
...
try {
  $null = Invoke-RestMethod -Uri "https://api.github.com/repos/Manjith-NG/NFA-2.0-Ver" -TimeoutSec 12
...
Write-Host "  https://github.com/Manjith-NG/NFA-2.0-Ver" -ForegroundColor Cyan
Write-Host ""
